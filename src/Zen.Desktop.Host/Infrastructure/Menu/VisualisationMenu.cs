...
public class VisualisationMenu : MenuBase
{
    public override List<Label> GetMenu()
    {
        var items = new List<Label>
        {
            ...
            new(4, false, $"[4] {(AppSettings.Instance.Visualisation == Visualisation.VideoBanks ? ">" : " ")} Both Video Banks (128k) {(AppSettings.Instance.Visualisation == Visualisation.VideoBanks ? "<" : " ")}", Color.Yellow, 1, 9, Keys.D4, Color.LightGreen),
