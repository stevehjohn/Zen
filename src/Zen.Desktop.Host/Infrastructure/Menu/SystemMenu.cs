        ...
        var items = new List<Label>
                    {
                        ...
                        new(4, false, $"[4] {(AppSettings.Instance.SystemModel == Model.SpectrumPlus2A ? ">" : " ")} Spectrum +2 {(AppSettings.Instance.SystemModel == Model.SpectrumPlus2A ? "<" : " ")}", Color.Yellow, 1, 9, Keys.D4, Color.LightGreen),
