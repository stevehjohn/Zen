        ...
        var items = new List<Label>
                    {
                        ...
                        new(4, false, $"[4] {(AppSettings.Instance.SystemModel == Model.SpectrumPlus2A ? ">" : " ")} Spectrum +2A {(AppSettings.Instance.SystemModel == Model.SpectrumPlus2A ? "<" : " ")}", Color.Yellow, 1, 9, Keys.D4, Color.LightGreen),
                        new(5, false, $"[5] {(AppSettings.Instance.SystemModel == Model.SpectrumPlus3 ? ">" : " ")} Spectrum +3 {(AppSettings.Instance.SystemModel == Model.SpectrumPlus3 ? "<" : " ")}", Color.Yellow, 1, 11, Keys.D5, Color.LightGreen),
