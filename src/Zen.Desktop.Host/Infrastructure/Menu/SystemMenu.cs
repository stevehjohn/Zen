        ...
        var items = new List<Label>
                    {
                        ...
                        new(2, false, $"[2] {(AppSettings.Instance.SystemModel == Model.Spectrum128 ? " " : ">")} Spectrum 128 {(AppSettings.Instance.SystemModel == Model.Spectrum48K ? " " : "<")}", Color.Yellow, 1, 5, Keys.D2, Color.LightGreen),
                        new(3, false, $"[3] {(AppSettings.Instance.SystemModel == Model.SpectrumPlus2 ? " " : ">")} Spectrum +2 {(AppSettings.Instance.SystemModel == Model.Spectrum48K ? " " : "<")}", Color.Yellow, 1, 7, Keys.D3, Color.LightGreen),
                        new(4, false, $"[4] {(AppSettings.Instance.SystemModel == Model.SpectrumPlus3 ? " " : ">")} Spectrum +3 {(AppSettings.Instance.SystemModel == Model.Spectrum48K ? " " : "<")}", Color.Yellow, 1, 9, Keys.D4, Color.LightGreen),
