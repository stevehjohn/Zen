        ...
        var items = new List<Label>
                    {
                        ...
                        new(2, false, $"[1] {(AppSettings.Instance.Speed == Speed.Normal ? ">" : " ")} Normal {(AppSettings.Instance.Speed == Speed.Normal ? "<" : " ")}", Color.Yellow, 1, 5, Keys.D1, Color.LightGreen),
                        new(3, false, $"[2] {(AppSettings.Instance.Speed == Speed.Fast ? ">" : " ")} Fast {(AppSettings.Instance.Speed == Speed.Fast ? "<" : " ")}", Color.Yellow, 1, 7, Keys.D2, Color.LightGreen),
