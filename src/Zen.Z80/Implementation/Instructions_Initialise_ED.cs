...
public partial class Instructions
{
    ...
    {
        _instructions.Add(0xED40, new Instruction(_ => IN_R_C(Register.B), "IN B, (C)", 0, 0xED40));
        ...
        _instructions.Add(0xED48, new Instruction(_ => IN_R_C(Register.C), "IN C, (C)", 0, 0xED48));
        ...
        _instructions.Add(0xED50, new Instruction(_ => IN_R_C(Register.D), "IN D, (C)", 0, 0xED50));
        ...
        _instructions.Add(0xED58, new Instruction(_ => IN_R_C(Register.E), "IN E, (C)", 0, 0xED58));
        ...
        _instructions.Add(0xED60, new Instruction(_ => IN_R_C(Register.H), "IN H, (C)", 0, 0xED60));
        ...
        _instructions.Add(0xED68, new Instruction(_ => IN_R_C(Register.L), "IN L, (C)", 0, 0xED68));
        ...
        _instructions.Add(0xED70, new Instruction(_ => IN_C(), "IN (C)", 0, 0xED70));
        ...
        _instructions.Add(0xED78, new Instruction(_ => IN_R_C(Register.A), "IN A, (C)", 0, 0xED78));
