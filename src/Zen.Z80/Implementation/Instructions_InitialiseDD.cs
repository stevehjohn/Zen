...
public partial class Instructions
{
    private void InitialiseDDInstructions()
    {
        ...
        _instructions.Add(0xDD11, new Instruction(d => LD_RR_nn(RegisterPair.DE, d), "LD DE, nn", 0xDD11, 2, null, 4));

        _instructions.Add(0xDD21, new Instruction(d => LD_RR_nn(RegisterPair.IX, d), "LD IX, nn", 0xDD21, 2, null, 4));
