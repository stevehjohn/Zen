...
public partial class Instructions
{
    ...
    private void InitialiseMiscFDInstructions()
    {
        ...
        _instructions.Add(0xFD36, new Instruction(p => LD_aRRd_n(RegisterPair.IY, p), "LD (IY + d), n", 0xFD36, 2, 4));
        ...
        _instructions.Add(0xFDE1, new Instruction(_ => POP(RegisterPair.IY), "POP IY", 0xFDE1, 0, 4));

        _instructions.Add(0xFDE3, new Instruction(_ => EX_aSP_RR(RegisterPair.IY), "EX (SP), IY", 0xFDE3, 0, 4));

        _instructions.Add(0xFDE5, new Instruction(_ => PUSH(RegisterPair.IY), "PUSH IY", 0xFDE5, 0, 4));

        _instructions.Add(0xFDE9, new Instruction(_ => JP_RR(RegisterPair.IY), "JP IY", 0xFDE9, 0, 4));
