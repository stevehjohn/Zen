...
cd ./src/Zen.Desktop.Host/bin/Release/*/osx-x64/publish
pwd
chmod +xx Zen.Desktop.Host
rm *.zip
zip -r Zen.Desktop.Host.macOS.Intel.zip *
cd -
mv ./src/Zen.Desktop.Host/bin/Release/*/osx-x64/publish/Zen.Desktop.Host.macOS.Intel.zip .

cd ./src/Zen.Desktop.Host/bin/Release/*/osx-arm64/publish
pwd
chmod +xx Zen.Desktop.Host
rm *.zip
zip -r Zen.Desktop.Host.macOS.Apple.zip *
cd -
mv ./src/Zen.Desktop.Host/bin/Release/*/osx-arm64/publish/Zen.Desktop.Host.macOS.Apple.zip .

cd ./src/Zen.Desktop.Host/bin/Release/*/win-x64/publish
pwd
rm *.zip
zip -r Zen.Desktop.Host.Windows.Intel.zip *
cd -
mv ./src/Zen.Desktop.Host/bin/Release/*/win-x64/publish/Zen.Desktop.Host.Windows.Intel.zip .

cd ./src/Zen.Desktop.Host/bin/Release/*/linux-x64/publish
pwd
rm *.zip
zip -r Zen.Desktop.Host.Linux.Intel.zip *
cd -
mv ./src/Zen.Desktop.Host/bin/Release/*/linux-x64/publish/Zen.Desktop.Host.Linux.Intel.zip .

cd ./src/Zen.Desktop.Host/bin/Release/*/linux-arm64/publish
pwd
rm *.zip
zip -r Zen.Desktop.Host.Linux.Arm.zip *
cd -
mv ./src/Zen.Desktop.Host/bin/Release/*/linux-arm64/publish/Zen.Desktop.Host.Linux.Arm.zip .
